...
<head>
	...
	<title>--WebSite Name--- - Check Booking</title>
...
$q = mysql_query("SELECT * FROM spain WHERE id ='".$gid."'") or die ("mysql error");
    ...
    <div class="lightbox" style="display:block;">
		<div class="lb-wrap">
			...
			<div class="lb-content">
				<form name="bookform" method="POST" action="my_account">
					<h1>Check your booking</h1>
					<div class="f-item">
						<label for="email">Booking number</label>
						<input type="text" id="email" name="booknumber" />
					</div>
					<input type="hidden" name="checkbooking" value="TRUE" />
					<input type="submit" id="login" name="login" value="Check your booking" class="gradient-button"/>
				</form>
