...
?>	                   
						...
						<?php
echo "<form id=\"booking\" name = \"bookingform\" onsubmit=\"return validateForm()\" method=\"post\" action=\"add_inquiryhotdeals.php?id=".$row['id']."\" class=\"booking\">\n"; 
echo "\n";
?>	
                                ...
                                <div class="row twins">
									<div class="f-item">
										...
										<input type="text" id="first_name" name="name" placeholder="Please enter your name"/>
								...
								<div class="row">
									<div class="f-item">
										...
										<textarea name="message" rows="10" cols="10">I would like to inquire about the property <?php echo $row['title']; ?>.</textarea>
									</div>
