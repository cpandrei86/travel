...
<head>
	...
	<title>--WebSite Name--- - Switzerland</title>
...
?>
							<div class="bottom-nav">
								...
								<!--pager-->
								<div class="pager">
								<span><?php echo "<a href='locationswitzerland?page=1'>".'First page'."</a> "; // Goto 1st page  ?> </a></span>
									...
									<span><?php echo "<a href='locationswitzerland?page=".$i."'>".$i."</a> ";?></span>
									
                                     <?php
	};					
 ?>
									<span><?php echo "<a href='locationswitzerland?page=$total_pages'>".'Last page'."</a> "; // Goto last page ?></a></span>
								</div>
								<!--//pager-->
							</div>
							<!--//bottom navigation-->
				...
				<aside class="right-sidebar">
					...
					<article class="default clearfix">
						...
						<ul class="popular-hotels">
							<li>
								<a href="https://www.tripadvisor.com/Hotel_Review-g188052-d267307-Reviews-Schweizerhof_Hotel_Spa-Bern_Bern_Mittelland_District_Canton_of_Bern.html" target="_blank">
									<h3>Schweizerhof Hotel & Spa
										<span class="stars">
											<img src="images/ico/star.png" alt="" />
											<img src="images/ico/star.png" alt="" />
											<img src="images/ico/star.png" alt="" />
									...
									<p>From <span class="price">€ 338 <small>/ per night</small></span></p>
									
								</a>
							</li>
							<li>
								<a href="https://www.tripadvisor.com/Hotel_Review-g188113-d234254-Reviews-Hotel_Glaernischhof-Zurich.html" target="_blank">
									<h3>Hotel Glaernischhof
										<span class="stars">
											<img src="images/ico/star.png" alt="" />
											<img src="images/ico/star.png" alt="" />
											<img src="images/ico/star.png" alt="" />
									...
									<p>From <span class="price">€ 258 <small>/ per night</small></span></p>
									
								</a>
							</li>
							<li>
								<a href="https://www.tripadvisor.com/Hotel_Review-g188113-d228232-Reviews-Storchen_Zurich-Zurich.html" target="_blank">
									<h3>Storchen Zurich
										<span class="stars">
											<img src="images/ico/star.png" alt="" />
											<img src="images/ico/star.png" alt="" />
									...
									<p>From <span class="price">€ 536 <small>/ per night</small></span></p>
									
								</a>
							</li>
							<li>
								<a href="https://www.tripadvisor.com/Hotel_Review-g188098-d278486-Reviews-BELLERIVE-Zermatt_Canton_of_Valais_Swiss_Alps.html" target="_blank">
									<h3>BELLERIVE
										<span class="stars">
											<img src="images/ico/star.png" alt="" />
											<img src="images/ico/star.png" alt="" />
									...
									<p>From <span class="price">€ 223 <small>/ per night</small></span></p>
