...
<head>
	...
	<title>--WebSite Name--- - United Kingdom</title>
...
?>
							<div class="bottom-nav">
								...
								<!--pager-->
								<div class="pager">
								<span><?php echo "<a href='locationlondon?page=1'>".'First page'."</a> "; // Goto 1st page  ?> </a></span>
									...
									<span><?php echo "<a href='locationlondon?page=".$i."'>".$i."</a> ";?></span>
									
                                     <?php
	};					
 ?>
									<span><?php echo "<a href='locationlondon?page=$total_pages'>".'Last page'."</a> "; // Goto last page ?></a></span>
								</div>
								<!--//pager-->
							</div>
							<!--//bottom navigation-->
				...
				<aside class="right-sidebar">
					...
					<article class="default clearfix">
						...
						<ul class="popular-hotels">
							<li>
								<a href="https://www.tripadvisor.com/Hotel_Review-g186338-d195198-Reviews-Crowne_Plaza_London_Kensington-London_England.html" target="_blank">
									<h3>Crowne Plaza
										<span class="stars">
											<img src="images/ico/star.png" alt="" />
											<img src="images/ico/star.png" alt="" />
									...
									<p>From <span class="price">€ 129 <small>/ per night</small></span></p>
									
								</a>
							</li>
							<li>
								<a href="https://www.tripadvisor.com/Hotel_Review-g186338-d187591-Reviews-The_Ritz_London-London_England.html" target="_blank">
									<h3>The Ritz London
										<span class="stars">
											<img src="images/ico/star.png" alt="" />
											<img src="images/ico/star.png" alt="" />
									...
									<p>From <span class="price">€ 401 <small>/ per night</small></span></p>
									
								</a>
							</li>
							<li>
								<a href="https://www.tripadvisor.com/Hotel_Review-g186338-d195217-Reviews-K_K_Hotel_George-London_England.html" target="_blank">
									<h3>K+K Hotel George
										<span class="stars">
											<img src="images/ico/star.png" alt="" />
											<img src="images/ico/star.png" alt="" />
									...
									<p>From <span class="price">€ 108 <small>/ per night</small></span></p>
									
								</a>
							</li>
							<li>
								<a href="https://www.tripadvisor.com/Hotel_Review-g186338-d1371050-Reviews-The_Kensington-London_England.html" target="_blank">
									<h3>The Kensington
										<span class="stars">
											<img src="images/ico/star.png" alt="" />
											<img src="images/ico/star.png" alt="" />
									...
									<p>From <span class="price">€ 192 <small>/ per night</small></span></p>
