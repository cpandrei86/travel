...
<script type="text/javascript">
	function initialize() {
		var secheltLoc = new google.maps.LatLng(39.814924, 4.277422);
		...
		var marker = new google.maps.Marker({
			map: theMap,
			draggable: true,
			position: new google.maps.LatLng(39.814924, 4.277422),
			visible: true
		});

		var boxText = document.createElement("div");
		boxText.innerHTML = "Carrer de s'Illa, 07713,<br/> <br/> Punta Prima, Illes Balears, Spain ";
			...
			<div class="content clearfix">
				...
				<nav role="navigation" class="breadcrumbs clearfix">
					...
					<ul class="top-right-nav">
						...
						<li><a href="index.php" title="Change search">Change search</a></li>
					</ul>
					<!--//top right navigation-->
				</nav>
				<!--//breadcrumbs-->
...
?>
					<article class="hotel-details clearfix">
						...
						<span class="stars">
							...
							<p><h4>Price: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; € <?php echo $row['price']; ?> / night <br/> Max Guests: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<?php echo $row['generale']; ?></h4>  </p>
						</div>					
						<div class="description">
						...
						<div class="tags">
							<?php
echo "<a href= \"inquiry?id=".$row['id']."\" title=\"Book now\" class=\"gradient-button\">&nbsp;&nbsp;Inquiry&nbsp;&nbsp;</a>\n";
?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<?php
echo "<a href= \"booking-step1?id=".$row['id']."\" title=\"Book now\" class=\"gradient-button\">Book now</a>\n";
?>
						</div>
					</article>
                         <?php
