...
?>	                   
						...
						<?php
echo "<form id=\"booking\" name = \"bookingform\" onsubmit=\"return validateForm()\" method=\"post\" action=\"add_bookinghotdeals.php?id=".$row['id']."\" class=\"booking\">\n"; 
echo "\n";
?>	
				...
				<aside class="right-sidebar">
                    ...
                    <?php echo "<img src=\"".$row['poza1']."\" style=\"width:100%;\" /></a>"; ?>
						...
						<div class="booking-info">
							...
							<p><div class="datepicker-wrap"><input type="text" placeholder="" id="datepicker4" 
                            name="datepicker4" readonly/></div></p>
							<h6>Check-out Date</h6>
							<p><div class="datepicker-wrap"><input type="text" placeholder="" id="datepicker5" 
